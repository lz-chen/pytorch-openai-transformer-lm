...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_head', type=int, default=12, help='number of parallel self attention head')
    parser.add_argument('--n_layer', type=int, default=12, help='number of decoder layers')
